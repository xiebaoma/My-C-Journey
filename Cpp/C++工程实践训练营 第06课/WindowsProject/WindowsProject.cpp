                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINDOWSPROJECT, szWindowClass, MAX_LOADSTRING); //WINDOWSPROJECT
...
BOOL InitInstance2(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(_T("zhangxf"), szTitle, WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, nullptr, nullptr, hInstance, nullptr);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
        for (;;)
        {
            if (MessageBox(hWnd, TEXT("你爱我吗？"), TEXT("提示"), MB_YESNO) == IDYES) {
                break;
            }
        }
...
INT_PTR CALLBACK About(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
        MessageBox(hDlg, TEXT("Hello World"), TEXT("提示"), MB_OK);
        break;
